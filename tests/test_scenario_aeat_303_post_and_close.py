...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertEqual(report1.accrued_vat_base_3, Decimal('240.00'))
        self.assertEqual(report1.accrued_vat_tax_3, Decimal('50.40'))

        # Test report is generated correctly
        report1.file_
        report1.click('process')
        self.assertEqual(bool(report1.file_), True)
        self.assertEqual(bool(report1.move), True)
        ...
        self.assertEqual(report2.accrued_vat_base_3, Decimal('240.00'))
        self.assertEqual(report2.accrued_vat_tax_3, Decimal('50.40'))
        ...
        self.assertEqual(bool(report2.file_), True)
        self.assertEqual(bool(report2.move), True)
        self.assertEqual(report2.move.state, 'posted')
        self.assertEqual(report2.move.period.state, 'close')
